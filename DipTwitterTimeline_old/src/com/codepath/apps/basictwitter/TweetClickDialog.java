...
public class TweetClickDialog extends DialogFragment {
	...
	public static TweetClickDialog newInstance(Tweet tweet, User defaultUser) {
		TweetClickDialog  frag = new TweetClickDialog();
		Bundle args = new Bundle();
				
		args.putSerializable("tweet", tweet);
		args.putSerializable("myuser", TweetUtility.defaultUser);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.dialog_click_tweet, container);
	    ...
	    btnReply.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				//dipu ComposeDialog editFilterDialog = ComposeDialog.newInstance("reply", tweet, myUser);
